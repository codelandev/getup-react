...
var CanvasMenu = React.createClass({displayName: 'CanvasMenu',

  render: function() {
    return (
      React.createElement("div", {className: "canvas-menu"}, 
        React.createElement("ul", null, 
          React.createElement("li", {className: "sidemenu-item"}, React.createElement("a", {href: ""}, React.createElement("i", {className: "fa fa-user"}), " mateus@getupcloud.com")), 
          React.createElement("li", {className: "sidemenu-item"}, React.createElement("a", {href: ""}, "Aplicações ", React.createElement("i", {className: "fa fa-angle-right right medium-font"}))), 
          React.createElement("li", {className: "sidemenu-item"}, React.createElement("a", {href: ""}, "Minha conta ", React.createElement("i", {className: "fa fa-angle-right right medium-font"}))), 
          React.createElement("li", {className: "sidemenu-item"}, React.createElement("a", {href: ""}, "Configurações ", React.createElement("i", {className: "fa fa-angle-right right medium-font"}))), 
          React.createElement("li", {className: "sidemenu-item"}, React.createElement("a", {href: ""}, "Ajuda ", React.createElement("i", {className: "fa fa-angle-right right medium-font"})))
        )
      )
    );
  }
...
var Sidemenu = React.createClass({displayName: 'Sidemenu',
  ...
  render: function() {
    return (
      React.createElement("aside", {className: "sidemenu"}, 
        React.createElement("ul", {className: "sidemenu-list"}, 
          React.createElement("li", {className: "sidemenu-item"}, 
            React.createElement("a", {className: "sidemenu-button"}, 
          ...
          React.createElement("li", {className: "sidemenu-item"}, 
            React.createElement("a", null, React.createElement("i", {className: "fa fa-cloud"}))
          ), 
          React.createElement("li", {className: "sidemenu-item"}, 
            React.createElement("a", null, React.createElement("i", {className: "fa fa-user"}))
          ), 
          React.createElement("li", {className: "sidemenu-item"}, 
            React.createElement("a", null, React.createElement("i", {className: "fa fa-gears"}))
          ), 
          React.createElement("li", {className: "sidemenu-item"}, 
            React.createElement("a", null, React.createElement("i", {className: "fa fa-question-circle"}))
          )
        )
      )
    );
...
React.render(React.createElement(Nav, null), document.querySelector('.navbar'));
React.render(React.createElement(Sidemenu, null), document.querySelector('.sidemenus'));
React.render(React.createElement(CanvasMenu, null), document.querySelector('.canvas'));
...
},{"./components/canvas":149,"./components/nav":150,"./components/sidemenu":151,"jquery":2,"react":148}]},{},[152])